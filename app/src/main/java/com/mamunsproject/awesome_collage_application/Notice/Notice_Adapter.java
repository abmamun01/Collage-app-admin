...
public class Notice_Adapter extends RecyclerView.Adapter<Notice_Adapter.NoticeViewAdapter> {
    ...
    public void onBindViewHolder(@NonNull NoticeViewAdapter holder, int position) {
        ...
        try {
            ...
            Picasso.get().load(currentItem.getImage()).into(holder.deleteNotice_Image);
        } catch (Exception e) {
            e.printStackTrace();
        }
            ...
            builder.setPositiveButton(
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //ata notify kore dibo jate amra bolte pari ai position r data k recyclerview theke delete kroe dew
    ...
    public class NoticeViewAdapter extends RecyclerView.ViewHolder {
        ...
        private TextView deleteNotice_Title;
